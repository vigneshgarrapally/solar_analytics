...
if __name__ == "__main__":
    ...
    now_in_ist = dt.datetime.now(IST)

    # Calculate the date for the "previous day" according to IST
    target_date = (now_in_ist - dt.timedelta(days=1)).date()

    print(
        f"📅 Starting data pull for the previous day: {target_date.isoformat()}..."
    )
